...
A multi-display command center for Raspberry Pi 4, designed as a physical dashboard for [OpenClaw](https://github.com/openclawai/openclaw) AI agents. Features a cyberpunk-themed UI with Molty the space lobster mascot.
...
📖 **15-Minute Setup**: See [`QUICKSTART_PI4B.md`](QUICKSTART_PI4B.md)
📖 **Full Guide**: See [`SETUP_PI4B.md`](SETUP_PI4B.md)
...
### Original Raspberry Pi 4 Setup (Dual SPI Displays)

The original configuration with two SPI displays:
